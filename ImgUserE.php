				...
				<div id="userEsp">
					<div id="izq">
						...
						<div class="list-group">
						  <a href="PerfilUserE.php" class="list-group-item">Información de Perfil</a>
						  <a href="ImgUserE.php" class="list-group-item active">Cambiar Imagen</a>
						  <a href="#" class="list-group-item">Editar Información Perfil</a>
						  <a href="#" class="list-group-item">Editar Información Tienda</a>
