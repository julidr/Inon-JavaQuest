...
<head>
	...
	<body>
		<?php
			...
			$query="call obtenerInfoE('".$_SESSION['userid']."');";
			$result=mysqli_query($connection, $query);
			$row=mysqli_fetch_assoc($result);
			$_SESSION['tienda']=$row['nombreT'];
			...
			$_SESSION['telefonoT']=$row['telefonoT'];
			$_SESSION['pais']=$row['paisT'];
			$_SESSION['ciudad']=$row['ciudadT'];
			$_SESSION['direccion']=$row['direccion'];
			$_SESSION['genero']=$row['genero'];
			$_SESSION['tarjeta']=$row['tarjeta'];
			$_SESSION['tipoT']=$row['tipoT'];
			$_SESSION['img']=$row['imagen'];
			$_SESSION['emailEm']=$row['emailT'];
			$_SESSION['descripcion']=$row['descrT'];
