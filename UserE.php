...
<body>
		...
		?>
			<div id="ContenedorPrincipal" name="ContenedorPrincipal" allign="center">
				...
				<hr>
					<div id="formularioUN" >
					  		<form id="infEmp" name="infEmp" role="form" method="Post" action="iu/php/crearEmpleado.php">
		              			<div id="FormularioN1" name="FormularioN1" class="col-md-6">
				                    ...
				                    <center><legend>Informacion de la Empresa</legend></center><br>
				                    <label>Nombre de la Empresa</label><input type="text" class="form-control"  id="nomEmp" name="nomEmp" ><br>
				                    <label>Pais</label>
				                    <?php
				                    ...
				                    <label>Correo Electronico</label><input type="email" class="form-control" id="emailEmp" name="emailEmp"><br><br>
		              			</div>

		              			<div id="FormularioN2" name="FormularioN2" class="col-md-6" >
				                    <center><legend>Informacion del Empleado</legend></center><br>
				                    ...
				                    <label>Telefono</label><input type="text" class="form-control"  id="telefonoEm" name="telefonoEm"><br>
				                    <label>Genero</label>  
				                    ...
				                    <label>Numero de Tarjeta</label><input type="text" class="form-control" id="ntarjeta" name="ntarjeta"><br>
				                    ...
				                    <label>Fecha de Vencimiento</label><input type="date" class="form-control" id="fechaV" name="fechaV"><br><br>
		              				...
		              				<center><button type="submit" class="btn btn-default" id="regE" name="regE">Registrar</button></center>
		              		</form>
					</div>
